...
class GherkinState {
    ...
    func printStepDefinitions() {
        ...
        print("-------------")
        print(self.steps.map { String(reflecting: $0) }.sort { $0.lowercaseString < $1.lowercaseString }.joinWithSeparator("\n"))
        print("-------------")
    }
...
public extension XCTestCase {
    ...
    internal var state: GherkinState {
        self.dynamicType.state.test = self
        return self.dynamicType.state
    }
...
extension XCTestCase {
    ...
    */
    func addStep(_ expression: String, file: String, line: Int, _ function: ([String])->()) {
